...
int main() {
    ...
    while (login_loop == 0)
    {
        ...
        if(p->tm_wday == 7)
        {
            ...
            cout << "There are " << sizeOfTutorList << " tutors." << endl;
            cout << "And " << 10 - sizeOfTutorList << " positions available" << endl;
        }
                ...
                else
                {
                    ...
                    if (ID.substr(0, 2) == "AD")
                    {
                        for (int i = 0; i < sizeOfAdminList; i++)
                        {
                            ...
                            {
                                cout << "Login success as an Admin" << endl << endl;
                                jud = true;
                    ...
                    {
                        //cout << "Logging in as an HR" << endl << endl;
                        //??? in my point of view, this system can be logged in by HRs and Admins, and the tutors are merely data? in that case, you should rewrite the HR part and make it function exactly as Admin.
                        for (int i = 0; i < sizeOfHRList; i++)
                        {
                            if (HRList[i].HRId == ID && HRList[i].password == pass)
                            {
                                cout << "Login success as an HR" << endl << endl;
                                jud = true;
